...
You refer to this secret in your Organization custom resources by the using the `connSecretRef` property:
...
spec:
  ...
  connSecretRef:
    ...
    # organization resource, but you can specify a different namespace.
    # namespace: mynamespace
